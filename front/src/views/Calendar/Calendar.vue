  ...
  <div>
    ...
    >
      <div class="container text-center py-3">
        <h3 class="display-5 text-white mb-2 animated slideInDown">
          게시글 상세보기
        </h3>
      </div>
    </div>
      ...
      <div class="detail">
        <div class="detail_diet">
          ...
          <div class="diet_">
            ...
            닭가슴살
            <input type="text" id="foodinfo" value="245.9 kcal" /><br />
...
.detail_diet {
  ...
  background: linear-gradient(
    ...
    url(../../assets/img/foodimg1.png) center/cover;
  color: black;
}
.diet_ {
  width: 50%;
